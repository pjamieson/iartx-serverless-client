    ...
    return (
      <form onSubmit={this.handleConfirmationSubmit}>
        <FormGroup controlId="confirmationCode" bsSize="large">
          ...
          <HelpBlock>To verify it's you who is signing up, please check your email for your confirmation code and enter it here.</HelpBlock>
        </FormGroup>
      ...
      <form onSubmit={this.handleSubmit}>
        <FormGroup controlId="username" bsSize="large">
          ...
          <FormControl autoFocus type="email"
            ...
            onChange={this.handleChange} />
            <HelpBlock>We will never provide your email address to any third party. You will only receive email from us, if you choose to opt-in in your account profile.</HelpBlock>
        </FormGroup>
